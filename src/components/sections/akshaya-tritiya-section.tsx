      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative mx-auto mt-6 max-w-3xl rounded-2xl border-4 border-[#8b3a1f] bg-gradient-to-br from-[#fff9f0] to-[#fde9bf] px-6 py-7 shadow-lg">
          ...
          <p className="text-center font-serif text-lg font-semibold text-[#333]">
            Yat kinchid diyate danam svasthasya yad iva bahu, sarvam akshayam apnoti
          ...
          <p className="mt-5 text-center text-base leading-relaxed text-[#333]">
            ...
            <span className="ml-1">
              Even a small contribution brings <span className="italic">Akshaya Punya</span> and
              attracts unlimited blessings of the Lord for you and your family.
            </span>
          </p>
        ...
        <div className="mt-6 flex items-center justify-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-[#8b3a1f] tracking-widest">SACRED DAY</span>
            <span className="text-3xl text-[#8b3a1f]">✦</span>
          </div>
          ...
          <div className="max-w-2xl">
            ...
            <div className="mt-5 space-y-3 border-l-4 border-[#f2c26a] pl-5">
              <p className="text-sm leading-relaxed text-[#333] sm:text-base">
                ...
                <span>
                  Akshaya Tritiya is one of the most sacred days of the year, a time associated with
                  abundance, charity, and lasting spiritual merit.
                </span>
              </p>
              ...
              <p className="text-sm leading-relaxed text-[#333] sm:text-base">
                <span className="inline-block mb-2">◆</span>
                <span>
                  Even the smallest act of charity done on this day is believed to bring
                  <span className="font-bold text-[#8b3a1f]"> imperishable (Akshaya) punya.</span>
                </span>
              </p>
              ...
              <p className="text-sm leading-relaxed text-[#333] sm:text-base">
                <span className="inline-block mb-2">◆</span>
                <span>
                  Receive divine blessings for yourself and your family while helping build an iconic
                  temple at Gupt Vrindavan Dham, feed the needy, and protect the lives of
                  <span className="font-bold text-[#8b3a1f]"> 16,000+ abandoned and homeless Gau Mata.</span>
                </span>
              </p>
            </div>
