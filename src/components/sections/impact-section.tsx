  ...
  return (
    <section className="py-12 sm:py-14">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="overflow-hidden rounded-[32px] bg-[linear-gradient(120deg,var(--impactGradientStart)_0%,var(--buttonPrimary)_35%,var(--impactGradientMid)_72%,var(--impactGradientEnd)_100%)] px-6 py-8 text-[var(--textOnAccent)] shadow-[0_34px_90px_var(--shadowColor)] sm:px-8 sm:py-10 lg:px-12">
          <p className="text-sm font-semibold uppercase tracking-[0.3em] text-[var(--decorativeSoft)]">{content.eyebrow}</p>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {content.cards.map((card) => (
                <div key={card.title} className="rounded-[24px] border border-white/18 bg-white/10 p-4 backdrop-blur-sm">
                  <h3 className="text-lg font-semibold text-[var(--decorativeSoft)]">{card.title}</h3>
